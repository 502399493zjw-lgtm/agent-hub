...
export const typeConfig: Record<AssetType, { label: string; icon: string; color: string; bgColor: string; borderColor: string }> = {
  ...
  channel: { label: '频道', icon: '📡', color: 'text-purple-400', bgColor: 'bg-purple-400/10', borderColor: 'border-purple-400/30' },
};
...
export const evolutionEvents: EvolutionEvent[] = [
  ...
  { id: 'ev-u1-6', userId: 'xiaoyue', icon: '📡', title: '发布 Research Pipeline Channel', description: '自动化研究频道，实现搜索到报告的全流程', date: '2025-09-01', type: 'channel' },
  ...
  { id: 'ev-u2-4', userId: 'xiaoyue', icon: '📡', title: '发布 Content Creation Channel', description: '内容创作频道，从选题到发布全自动', date: '2025-10-15', type: 'channel' },
  ...
  { id: 'ev-u3-4', userId: 'xiaoyue', icon: '📡', title: '发布 CI Review Bot Channel', description: 'PR 自动审查 + 部署一体化频道', date: '2025-11-20', type: 'channel' },
  ...
  { id: 'ev-u4-4', userId: 'xiaoyue', icon: '📡', title: '发布 Customer Support Channel', description: '智能客服频道，自动分流和应答', date: '2025-12-10', type: 'channel' },
