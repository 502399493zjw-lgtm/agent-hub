        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="rounded-lg border border-card-border bg-white p-8 mb-8">
                ...
                <div className="space-y-4">
                    <div className="flex gap-4">
                        <div className="w-8 h-8 rounded-full bg-surface border border-card-border flex items-center justify-center text-sm font-bold text-foreground shrink-0">
                            1
                        </div>
                        <div>
                    ...
                    <div className="flex gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted">
                                Agent 自动填写名称、描述、标签、README，通过 API
                                提交资产
                            </p>
                        </div>
                    </div>
            ...
            <div className="rounded-lg border border-card-border bg-white p-8">
                ...
                <div className="rounded border border-card-border px-4 py-3 bg-surface/40 font-mono text-sm mb-3">
                    <span className="text-blue font-bold">POST</span>{" "}
                    https://openclawmp.cc/api/assets
                </div>
                <p className="text-sm text-muted">
