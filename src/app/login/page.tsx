    ...
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted mt-2 text-sm">欢迎回来，探索无限可能</p>
        </div>
        ...
        <div className="bg-white border border-card-border rounded-lg p-6 space-y-5 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-muted">或使用第三方登录</span>
            <div className="flex-1 h-px bg-card-border" />
          </div>
          ...
          <p className="text-center text-sm text-muted">
            还没有账号？{' '}
            <Link href="/register" className="text-blue hover:text-blue-dim transition-colors">
              立即注册
            </Link>
          </p>
        </div>
