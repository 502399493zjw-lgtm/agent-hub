...
const DB_PATH =
    process.env.DATABASE_URL || path.join(process.cwd(), "data", "hub.db");
const RAW_BASE =
...
const USECASES: UsecaseDef[] = [
    // ══════ 全部 Experience ══════
    {
        ...
        type: "experience",
        displayName: "Reddit 每日精选",
        category: "社交媒体",
        tags: ["reddit", "digest", "cron", "daily"],
    },
    {
        file: "daily-youtube-digest",
        type: "experience",
        displayName: "YouTube 每日精选",
        category: "社交媒体",
        tags: ["youtube", "digest", "cron", "daily"],
    },
    {
        file: "multi-source-tech-news-digest",
        type: "experience",
        displayName: "多源科技新闻聚合",
        category: "社交媒体",
        tags: ["news", "rss", "twitter", "github", "cron"],
    },
    {
        file: "youtube-content-pipeline",
        type: "experience",
        displayName: "YouTube 内容创作流水线",
        category: "创意与构建",
        tags: ["youtube", "content", "cron", "hourly"],
    },
    {
        ...
        displayName: "邮箱自动整理",
        category: "效率工具",
        tags: ["email", "newsletter", "digest", "cron"],
    },
    {
        file: "polymarket-autopilot",
        type: "experience",
        displayName: "Polymarket 自动交易",
        category: "金融与交易",
        tags: ["polymarket", "trading", "monitor", "cron"],
    },
    {
        ...
        displayName: "动态数据仪表盘",
        category: "效率工具",
        tags: ["dashboard", "api", "monitor", "cron"],
    },
    {
        file: "project-state-management",
        type: "experience",
        displayName: "事件驱动项目管理",
        category: "效率工具",
        tags: ["project", "state", "event-driven", "cron"],
    },
    {
        file: "market-research-product-factory",
        type: "experience",
        displayName: "市场调研与产品工厂",
        category: "研究与学习",
        tags: ["research", "reddit", "product", "cron"],
    },
    {
        file: "x-account-analysis",
        type: "experience",
        displayName: "X/Twitter 账号分析",
        category: "社交媒体",
        tags: ["twitter", "x", "analysis"],
    },
    {
        file: "todoist-task-manager",
        type: "experience",
        displayName: "Todoist 任务管理",
        category: "效率工具",
        tags: ["todoist", "tasks", "visualization"],
    },
    {
        file: "knowledge-base-rag",
        type: "experience",
        displayName: "个人知识库 (RAG)",
        category: "研究与学习",
    ...
    },
    {
        ...
        displayName: "语义记忆搜索",
        category: "研究与学习",
        tags: ["memory", "vector", "search", "memsearch"],
    },
    {
        file: "n8n-workflow-orchestration",
        type: "experience",
        displayName: "n8n 工作流编排",
        category: "基础设施与运维",
        tags: ["n8n", "workflow", "webhook", "api"],
    },
    {
        ...
        displayName: "电话语音助手",
        category: "效率工具",
        tags: ["phone", "voice", "telnyx", "clawdtalk"],
    },
    {
        file: "self-healing-home-server",
        type: "experience",
        displayName: "自愈式家庭服务器",
        category: "基础设施与运维",
        tags: ["server", "ssh", "cron", "self-healing", "devops"],
    },
    {
        file: "multi-agent-team",
        type: "experience",
        displayName: "多 Agent 专业团队",
        category: "效率工具",
        tags: ["multi-agent", "team", "telegram", "cron"],
    },
    {
        file: "overnight-mini-app-builder",
        type: "experience",
        displayName: "目标驱动自主任务",
        category: "创意与构建",
        tags: ["autonomous", "goal-driven", "mini-app", "cron"],
    },
    {
        file: "content-factory",
        type: "experience",
        displayName: "多 Agent 内容工厂",
        category: "创意与构建",
        tags: ["content", "multi-agent", "discord", "pipeline"],
    },
    {
        file: "personal-crm",
        type: "experience",
        displayName: "个人 CRM 联系人管理",
        category: "效率工具",
        tags: ["crm", "contacts", "email", "calendar", "cron"],
    },
    {
        ...
        displayName: "健康与症状追踪",
        category: "效率工具",
        tags: ["health", "symptoms", "food", "tracking", "cron"],
    },
    {
        ...
        displayName: "AI 财报追踪",
        category: "研究与学习",
        tags: ["earnings", "finance", "alerts", "cron"],
    },
    {
        ...
        displayName: "定制晨间简报",
        category: "效率工具",
        tags: ["morning", "briefing", "news", "tasks", "cron"],
    },
    {
        ...
        displayName: "多渠道个人助手",
        category: "效率工具",
        tags: ["multi-channel", "telegram", "slack", "cron"],
    },
    {
        file: "family-calendar-household-assistant",
        type: "experience",
        displayName: "家庭日历与家务助手",
        category: "效率工具",
        tags: ["family", "calendar", "household", "cron"],
    },
    {
        file: "second-brain",
        type: "experience",
        displayName: "第二大脑",
        category: "效率工具",
        tags: ["memory", "notes", "dashboard", "next-js"],
    },
    {
        ...
        displayName: "自主项目管理",
        category: "效率工具",
        tags: ["project", "state-yaml", "multi-agent"],
    },
    {
        file: "multi-channel-customer-service",
        type: "experience",
        displayName: "多渠道 AI 客服",
        category: "效率工具",
        tags: ["customer-service", "whatsapp", "instagram", "email"],
    },
    {
        ...
        displayName: "活动嘉宾确认",
        category: "效率工具",
        tags: ["events", "phone-call", "supercall", "voice"],
    },
];
...
async function translateToChineseSummary(
    markdown: string,
    displayName: string,
): Promise<string> {
    ...
    chineseReadme.push("");
    chineseReadme.push(
        `> 原始来源：[awesome-openclaw-usecases](https://github.com/hesamsheikh/awesome-openclaw-usecases)`,
    );
    chineseReadme.push("");
...
function insertUsecase(
    ...
    const name = def.file;
    const description =
        extractDescription(chineseReadme) || extractDescription(markdown);
  ...
  `);
    ...
    stmt.run({
        ...
        versions: JSON.stringify([
            {
                version: "1.0.0",
                changelog: "Imported from awesome-openclaw-usecases",
                date: now,
            },
        ]),
...
async function main() {
    ...
    for (let i = 0; i < USECASES.length; i++) {
        ...
        process.stdout.write(
            `[${i + 1}/${USECASES.length}] ${typeEmoji[def.type] || "📦"} ${def.displayName}...`,
        );

        try {
            const markdown = await fetchMarkdown(def.file);
            const chineseReadme = await translateToChineseSummary(
                markdown,
                def.displayName,
            );
            ...
            if (dryRun) {
                console.log(
                    ` ✅ ${markdown.length} chars → 中文 ${chineseReadme.length} chars (dry-run)`,
                );
                success++;
                continue;
            }
            ...
            const existing = db!
                ...
                .get(def.file) as { id: string } | undefined;
            if (existing) {
